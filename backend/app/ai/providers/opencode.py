"""OpenCode adapter — wraps the opencode CLI tool."""
...
class OpenCodeProvider(AIProviderBase):
    ...
    Wraps the `opencode` CLI tool for local execution.
    Requires opencode to be installed and available on PATH.
    """

    def __init__(self, config: ProviderConfig) -> None:
        super().__init__(config)
        self._authenticated = True  # CLI handles auth via config
